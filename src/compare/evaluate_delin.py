...
class Comparitor(object):
    ...
    def _calc_stats(self):
        ...
        self.matched_ref_sample = [val for index, val in enumerate(self.ref_sample) if index in self.matched_ref_inds]#self.ref_sample[self.matched_ref_inds] 
        self.unmatched_ref_sample = [val for index, val in enumerate(self.ref_sample) if index in self.unmatched_ref_inds]#self.ref_sample[self.unmatched_ref_inds]
        self.matched_test_sample = [val for index, val in enumerate(self.test_sample) if index in self.matched_test_inds]#self.test_sample[self.matched_test_inds]
        self.unmatched_test_sample = [val for index, val in enumerate(self.test_sample) if index in self.unmatched_test_inds]#self.test_sample[self.unmatched_test_inds]
